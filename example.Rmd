...
between the number and the caption is set by the `sep` argument. For conveniance the
desired values can be stored together with other R options.

```{r figOptions}
options(figcap.prefix="Figure", figcap.sep=":")
```
