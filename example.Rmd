...
[Markdown](http://daringfireball.net/projects/markdown/) documents with embedded R code to
...
If you add a space to the end of a line 
...
of the paragraph is suficient for the entire paragraph 
to be quoted.
> 
> > You can also qute other quotes, i.e. block quotes can be nested.
```
