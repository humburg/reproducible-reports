...
The system of ordinary differential equations given by Eq. (@volterra) 
is commonly used to describe predator-prey systems. Any solution to this
system of equations satisfies the equality in Eq. (@volterra_constant).
...
`align` environment is used only the first equation will be labelled. 
...
Unfortunately this results in spreading the the equation out across the entire
